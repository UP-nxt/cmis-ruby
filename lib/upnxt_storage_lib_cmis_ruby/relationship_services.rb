...
# services = UpnxtStorageLibCmisRuby::RelationshipServices.new
# puts services.get_object_relationships('blueprint', 'dayj2o53aj5w3ubfkjz4wn4hpki', nil, nil, 'cmis:relationship', nil, nil, nil, nil).body
